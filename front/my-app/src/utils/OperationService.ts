...
export class Operation {
    ...
    constructor(type: OperationType, pos: number, text: string, version: number, userID: number) {
        this.Type = type;
        this.Pos = pos;
        this.Text = text;
    ...
    public static createNoneOp(version = 0, userID = 0): Operation {
    ...
    public static createInsertOp(index: number, text: string, version = 0, userID = 0): Operation {
    ...
    public static createDeleteOp(index: number, text: string, version = 0, userID = 0): Operation {
    ...
    public static transformInsertInsert(op1: Operation, op2: Operation, op1Priority = false): Operation {
        ...
        return Operation.createInsertOp(op1.Pos + op2.Text.length, op1.Text, op1.Version, op1.UserID);
    }
    ...
    public static transformDeleteInsert(op1: Operation, op2: Operation): Operation {
        ...
        if (op1.Pos >= op2.Pos) {
            return Operation.createDeleteOp(op1.Pos + op2.Text.length, op1.Text, op1.Version, op1.UserID);
        }
        ...
        return Operation.createDeleteOp(op1.Pos, str, op1.Version, op1.UserID);
    }
    ...
    public static transformDeleteDelete(op1: Operation, op2: Operation): Operation {
        ...
        if (op2.Pos <= op1.Pos) {
            ...
            return Operation.createDeleteOp(op2.Pos, op1.Text.substring(op2.Pos + op2.Text.length - op1.Pos), op1.Version, op1.UserID);
        }
        ...
        return Operation.createDeleteOp(op1.Pos, op1.Text.substring(0, op2.Pos - op1.Pos), op1.Version, op1.UserID);
    }
}
